...
#include "BaseFPSBoundActionButton.h"

#include "CommonInputSubsystem.h"

void UBaseFPSBoundActionButton::NativeConstruct()
{
...
void UBaseFPSBoundActionButton::HandleInputMethodChanged(ECommonInputType NewInputMethod)
{
