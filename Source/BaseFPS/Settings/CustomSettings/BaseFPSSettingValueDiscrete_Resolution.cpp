...
#include "BaseFPSSettingValueDiscrete_Resolution.h"
...
#include UE_INLINE_GENERATED_CPP_BY_NAME(BaseFPSSettingValueDiscrete_Resolution)

#define LOCTEXT_NAMESPACE "BaseFPSSettings"

UBaseFPSSettingValueDiscrete_Resolution::UBaseFPSSettingValueDiscrete_Resolution()
{
}

void UBaseFPSSettingValueDiscrete_Resolution::StoreInitial()
{
	// ignored
}

void UBaseFPSSettingValueDiscrete_Resolution::ResetToDefault()
{
	// ignored
}

void UBaseFPSSettingValueDiscrete_Resolution::RestoreToInitial()
{
	// ignored
}

void UBaseFPSSettingValueDiscrete_Resolution::SetDiscreteOptionByIndex(int32 Index)
{
...
int32 UBaseFPSSettingValueDiscrete_Resolution::GetDiscreteOptionIndex() const
{
...
TArray<FText> UBaseFPSSettingValueDiscrete_Resolution::GetDiscreteOptions() const
{
...
void UBaseFPSSettingValueDiscrete_Resolution::OnInitialized()
{
	Super::OnInitialized();
...
void UBaseFPSSettingValueDiscrete_Resolution::OnDependencyChanged()
{
...
void UBaseFPSSettingValueDiscrete_Resolution::InitializeResolutions()
{
	Resolutions.Empty();
...
void UBaseFPSSettingValueDiscrete_Resolution::SelectAppropriateResolutions()
{
...
bool UBaseFPSSettingValueDiscrete_Resolution::ShouldAllowFullScreenResolution(const FScreenResolutionRHI& SrcScreenRes, int32 FilterThreshold) const
{
...
int32 UBaseFPSSettingValueDiscrete_Resolution::FindIndexOfDisplayResolution(const FIntPoint& InPoint) const
{
...
int32 UBaseFPSSettingValueDiscrete_Resolution::FindIndexOfDisplayResolutionForceValid(const FIntPoint& InPoint) const
{
...
int32 UBaseFPSSettingValueDiscrete_Resolution::FindClosestResolutionIndex(const FIntPoint& Resolution) const
{	
	int32 Index = 0;
...
void UBaseFPSSettingValueDiscrete_Resolution::GetStandardWindowResolutions(const FIntPoint& MinResolution, const FIntPoint& MaxResolution, float MinAspectRatio, TArray<FIntPoint>& OutResolutions)
{
...
FText UBaseFPSSettingValueDiscrete_Resolution::FScreenResolutionEntry::GetDisplayText() const
{
