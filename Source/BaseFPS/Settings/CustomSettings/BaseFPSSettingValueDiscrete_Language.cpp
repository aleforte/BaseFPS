...
#include "BaseFPSSettingValueDiscrete_Language.h"
...
UBaseFPSSettingValueDiscrete_Language::UBaseFPSSettingValueDiscrete_Language()
{
}

void UBaseFPSSettingValueDiscrete_Language::OnInitialized()
{
	Super::OnInitialized();
...
void UBaseFPSSettingValueDiscrete_Language::StoreInitial()
{
	// ?
}

void UBaseFPSSettingValueDiscrete_Language::OnApply()
{
...
void UBaseFPSSettingValueDiscrete_Language::ResetToDefault()
{
	SetDiscreteOptionByIndex(SettingSystemDefaultLanguageIndex);
}

void UBaseFPSSettingValueDiscrete_Language::RestoreToInitial()
{
	if (UBaseFPSSettingsShared* Settings = CastChecked<UBaseFPSLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
void UBaseFPSSettingValueDiscrete_Language::SetDiscreteOptionByIndex(int32 Index)
{
	if (UBaseFPSSettingsShared* Settings = CastChecked<UBaseFPSLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
int32 UBaseFPSSettingValueDiscrete_Language::GetDiscreteOptionIndex() const
{
	if (const UBaseFPSSettingsShared* Settings = CastChecked<UBaseFPSLocalPlayer>(LocalPlayer)->GetSharedSettings())
	{
...
TArray<FText> UBaseFPSSettingValueDiscrete_Language::GetDiscreteOptions() const
{
