...
#include "BaseFPSTabListWidgetBase.generated.h"
...
class UBaseFPSTabButtonInterface : public UInterface
{
	GENERATED_BODY()
};

class IBaseFPSTabButtonInterface
{
	GENERATED_BODY()
...
class BASEFPS_API UBaseFPSTabListWidgetBase : public UCommonTabListWidgetBase
{
	GENERATED_BODY()
...
public:
	...
	DECLARE_EVENT_TwoParams(UBaseFPSTabListWidgetBase, FOnTabContentCreatedNative, FName /* TabId */, UCommonUserWidget* /* TabWidget */);
...
protected:
	...
	//~End UCommonTabListWidgetBase interface
