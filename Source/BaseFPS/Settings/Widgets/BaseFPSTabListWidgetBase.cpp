...
bool UBaseFPSTabListWidgetBase::GetPreregisteredTabInfo(const FName TabNameId, FTabDescriptor& OutTabInfo)
{
...
void UBaseFPSTabListWidgetBase::SetTabHiddenState(FName TabNameId, bool bHidden)
{
...
bool UBaseFPSTabListWidgetBase::RegisterDynamicTab(const FTabDescriptor& TabDescriptor)
{
...
bool UBaseFPSTabListWidgetBase::IsFirstTabActive() const
{
...
bool UBaseFPSTabListWidgetBase::IsLastTabActive() const
{
	if (PreregisteredTabInfoArray.Num() > 0)
	{
...
bool UBaseFPSTabListWidgetBase::IsTabVisible(FName TabId)
{
...
int32 UBaseFPSTabListWidgetBase::GetVisibleTabCount()
{
	int32 Result = 0;
...
void UBaseFPSTabListWidgetBase::NativeOnInitialized()
{
	Super::NativeOnInitialized();
}

void UBaseFPSTabListWidgetBase::NativeConstruct()
{
...
void UBaseFPSTabListWidgetBase::NativeDestruct()
{
	for (FTabDescriptor& TabInfo: PreregisteredTabInfoArray)
	{
...
void UBaseFPSTabListWidgetBase::HandlePreLinkedSwitcherChanged()
{
...
void UBaseFPSTabListWidgetBase::HandlePostLinkedSwitcherChanged()
{
...
void UBaseFPSTabListWidgetBase::HandleTabCreation_Implementation(FName TabId, UCommonButtonBase* TabButton)
{
	...
	if (TabButton->GetClass()->ImplementsInterface(UBaseFPSTabButtonInterface::StaticClass()))
	{
		...
		{
			IBaseFPSTabButtonInterface::Execute_SetTabLabelInfo(TabButton, *TabInfoPtr);
		}
	}
...
void UBaseFPSTabListWidgetBase::SetupTabs()
{
	for (FTabDescriptor& TabInfo : PreregisteredTabInfoArray)
	{
		if (TabInfo.bHidden)
