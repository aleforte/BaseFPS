...
#include "CustomSettings/BaseFPSSettingValueDiscreteDynamic_AudioOutputDevice.h"
...
UGameSettingCollection* UBaseFPSSettingRegistry::InitializeAudioSettings(UBaseFPSLocalPlayer* InLocalPlayer)
{
	...
	/************************************************************************/
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UBaseFPSSettingsLocal>()->GetOverallVolume());
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UBaseFPSSettingsLocal>()->GetMusicVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UBaseFPSSettingsLocal>()->GetSoundFXVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UBaseFPSSettingsLocal>()->GetDialogueVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UBaseFPSSettingsLocal>()->GetVoiceChatVolume());
			Setting->SetDisplayFormat(UGameSettingValueScalarDynamic::ZeroToOnePercent);
	...
	/************************************************************************/
	{
		...
		//----------------------------------------------------------------------------------
		{
			...
			/************************************************************************/
			{
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UBaseFPSSettingsShared>()->GetSubtitlesEnabled());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UBaseFPSSettingsShared>()->GetSubtitlesTextSize());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UBaseFPSSettingsShared>()->GetSubtitlesTextColor());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UBaseFPSSettingsShared>()->GetSubtitlesTextBorder());
				...
				//----------------------------------------------------------------------------------
				{
					...
					Setting->SetDefaultValue(GetDefault<UBaseFPSSettingsShared>()->GetSubtitlesBackgroundOpacity());
		...
		//----------------------------------------------------------------------------------
		{
			UBaseFPSSettingValueDiscreteDynamic_AudioOutputDevice* Setting = NewObject<UBaseFPSSettingValueDiscreteDynamic_AudioOutputDevice>();
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UBaseFPSSettingsShared>()->GetAllowAudioInBackgroundSetting());
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UBaseFPSSettingsLocal>()->IsHeadphoneModeEnabled());

			Setting->AddEditCondition(MakeShared<FWhenCondition>(
				[](const ULocalPlayer*, FGameSettingEditableState& InOutEditState)
				{
					if (!GetDefault<UBaseFPSSettingsLocal>()->CanModifyHeadphoneModeEnabled())
					{
		...
		//----------------------------------------------------------------------------------
		{
			...
			Setting->SetDefaultValue(GetDefault<UBaseFPSSettingsLocal>()->IsHDRAudioModeEnabled());
