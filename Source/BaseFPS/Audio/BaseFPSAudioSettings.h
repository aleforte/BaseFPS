...
#include "BaseFPSAudioSettings.generated.h"

class USoundEffectSubmixPreset;
class USoundSubmix;

USTRUCT()
struct BASEFPS_API FSubmixEffectChainMap
{
	GENERATED_BODY()
 ...
 * 
 */
UCLASS(config = Game, defaultconfig, meta = (DisplayName = "BaseFPS Audio Settings"))
class BASEFPS_API UBaseFPSAudioSettings : public UDeveloperSettings
{
	GENERATED_BODY()
