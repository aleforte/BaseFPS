	...
	if (SessionInt.IsValid())
	{
		...
		if (Session)
		{
			...
			if (SessionInfo.IsValid())
			{
				...
				// FIX (aleforte) Steam is failing to add BuildId
				FString* BuildId = OldKeyValuePairs.Find(STEAMKEY_BUILDUNIQUEID);
				Session->SessionSettings.BuildUniqueId = FCString::Atoi(GetData(*BuildId));
